...
let g_dog = new g_Dog('dog')
// console.log(g_dog) // * [类的成员属性] 都是实例属性，而不是原型属性，[类的成员方法] 都是 [原型] 方法
// g_dog.pro() // 实例中不能调用受保护成员

// 类的继承
class g_Husky extends g_Dog {
...
const g_h = new g_Husky('name', 'color')
// console.log(g_h.color1) // 被public声明的实例属性，不需要在构造函数再定义，在这里可以直接使用
// console.log(g_h.color2)
// console.log(g_Husky.static) // 子类可以调用父类的静态成员